...
```{r hyperparameters}
pls_mixOmics_spec <- pls(num_comp = tune(),
                         predictor_prop = tune()
                         ) %>% 
  set_engine("mixOmics") %>% 
  set_mode("regression") %>% 
...
rf_grid_result <- tune_race_anova(object = pls_mixOmics_spec,
...
best_rmse <- rf_grid_result %>% 
  select_by_pct_loss("predictor_prop",
                     metric = "rmse",
                     limit = 2
                     )%>% 
...
compare_hyperparameters <- function(params_df, recipe, split) {
  ...
  for(i in 1:nrow(params_df)) {
    ...
    set.seed(10)
    current_spec <- pls(
      num_comp = current_params$num_comp,
      predictor_prop = current_params$predictor_prop
      ) %>%
      set_engine("mixOmics"
                 ) %>%
      set_mode('regression')
...
```{r final_spec}
final_spec <- pls(num_comp = best_rmse$num_comp,
                  predictor_prop = best_rmse$predictor_prop
                         ) %>% 
  set_engine("mixOmics") %>% 
  set_mode("regression")
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/09_PLS/M+W+S+O.png",
       width = 5,
       height = 5
       )
```
...
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/09_PLS/M+W+S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <- pls(num_comp = best_r2_2$num_comp,
                  predictor_prop = best_r2_2$predictor_prop
                         ) %>% 
  set_engine("mixOmics") %>% 
  set_mode("regression")
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/09_PLS/M+W+S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/09_PLS/M+W+S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <- pls(num_comp = best_rmse_2$num_comp,
                  predictor_prop = best_rmse_2$predictor_prop
                         ) %>% 
  set_engine("mixOmics") %>% 
  set_mode("regression")
...
plot <- final_fit %>%
  ...
  metrica::scatter_plot(obs = grade_n,
                        ...
                        metrics_list = c("R2", "RMSE"),
                      # Customize metrics position
                        position_metrics = c(x=78.6,y=73),
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/09_PLS/M+W+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/09_PLS/M+W+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/09_PLS/M+S+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/09_PLS/M+S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/09_PLS/W+S+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/09_PLS/W+S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <- pls(num_comp = best_r2$num_comp,
                  predictor_prop = best_r2$predictor_prop
                         ) %>% 
  set_engine("mixOmics") %>% 
  set_mode("regression")
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/09_PLS/M+W.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/09_PLS/M+W_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/09_PLS/M+S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/09_PLS/M+S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/09_PLS/M+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/09_PLS/M+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <- pls(num_comp = best_rmse_3$num_comp,
                  predictor_prop = best_rmse_3$predictor_prop
                         ) %>% 
  set_engine("mixOmics") %>% 
  set_mode("regression")
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/09_PLS/W+S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/09_PLS/W+S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/09_PLS/W+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/09_PLS/W+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/09_PLS/S+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/09_PLS/S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/09_PLS/M.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/09_PLS/M_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/09_PLS/W.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/09_PLS/W_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/09_PLS/S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/09_PLS/S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/09_PLS/O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/09_PLS/O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
