...
rf_grid_result <- tune_race_anova(object = svm_poly_kernlab_spec,
...
compare_hyperparameters <- function(params_df, recipe, split) {
  ...
  for(i in 1:nrow(params_df)) {
    ...
    set.seed(10)
    current_spec <- svm_poly(
      cost = current_params$cost,
      degree = current_params$degree,
      scale_factor = current_params$scale_factor,
      margin = current_params$margin,
      ) %>%
      set_engine("kernlab") %>%
      set_mode('regression')
...
```{r final_spec}
final_spec <- svm_poly(cost = best_rmse_2$cost, 
           degree = best_rmse_2$degree, 
           scale_factor = best_rmse_2$scale_factor, 
           margin = best_rmse_2$margin) %>%
  set_engine('kernlab') %>%
  set_mode('regression')
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/05_SVM_poly/M+W+S+O.png",
       width = 5,
       height = 5
       )
```
...
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/05_SVM_poly/M+W+S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <- svm_poly(cost = best_r2_3$cost, 
           degree = best_r2_3$degree, 
           scale_factor = best_r2_3$scale_factor, 
           margin = best_r2_3$margin) %>%
  set_engine('kernlab') %>%
  set_mode('regression')
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/05_SVM_poly/M+W+S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/05_SVM_poly/M+W+S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/05_SVM_poly/M+W+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/05_SVM_poly/M+W+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/05_SVM_poly/M+S+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/05_SVM_poly/M+S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <- svm_poly(cost = best_r2_2$cost, 
           degree = best_r2_2$degree, 
           scale_factor = best_r2_2$scale_factor, 
           margin = best_r2_2$margin) %>%
  set_engine('kernlab') %>%
  set_mode('regression')
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/05_SVM_poly/W+S+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/05_SVM_poly/W+S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <- svm_poly(cost = best_rmse$cost, 
           degree = best_rmse$degree, 
           scale_factor = best_rmse$scale_factor, 
           margin = best_rmse$margin) %>%
  set_engine('kernlab') %>%
  set_mode('regression')
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/05_SVM_poly/M+W.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/05_SVM_poly/M+W_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <- svm_poly(cost = best_r2$cost, 
           degree = best_r2$degree, 
           scale_factor = best_r2$scale_factor, 
           margin = best_r2$margin) %>%
  set_engine('kernlab') %>%
  set_mode('regression')
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/05_SVM_poly/M+S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/05_SVM_poly/M+S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
plot <- final_fit %>%
  ...
  metrica::scatter_plot(obs = grade_n,
                        ...
                        metrics_list = c("R2", "RMSE"),
                      # Customize metrics position
                        position_metrics = c(x=75,y=73.3),
                        position_eq = c(x=75, y =71))
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/05_SVM_poly/M+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/05_SVM_poly/M+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/05_SVM_poly/W+S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/05_SVM_poly/W+S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/05_SVM_poly/W+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/05_SVM_poly/W+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/05_SVM_poly/S+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/05_SVM_poly/S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/05_SVM_poly/M.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/05_SVM_poly/M_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
plot <- final_fit %>%
  ...
  metrica::scatter_plot(obs = grade_n,
                        ...
                        metrics_list = c("R2", "RMSE"),
                      # Customize metrics position
                        position_metrics = c(x=75,y=72.2),
                        position_eq = c(x=75, y =69.5))
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/05_SVM_poly/W.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/05_SVM_poly/W_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/05_SVM_poly/S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/05_SVM_poly/S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/05_SVM_poly/O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/05_SVM_poly/O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
