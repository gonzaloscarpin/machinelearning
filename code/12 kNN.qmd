...
rf_grid_result <- tune_race_anova(object = nn_spec,
...
compare_hyperparameters <- function(params_df, recipe, split) {
  ...
  for(i in 1:nrow(params_df)) {
    ...
    set.seed(10)
    current_spec <- nearest_neighbor(
      neighbors = current_params$neighbors,
      weight_func = current_params$weight_func,
      dist_power = current_params$dist_power
      ) %>%
      set_engine("kknn"
                 ) %>%
      set_mode('regression')
...
```{r final_spec}
final_spec <- nearest_neighbor(neighbors = best_rmse_2$neighbors,
                               weight_func = best_rmse_2$weight_func,
                               dist_power = best_rmse_2$dist_power
) %>%
  # Specify the engine
  set_engine("kknn") %>% 
  # Specifying mode  
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/10_kNN/M+W+S+O.png",
       width = 5,
       height = 5
       )
```
...
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/10_kNN/M+W+S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <- nearest_neighbor(neighbors = best_rmse$neighbors,
                               weight_func = best_rmse$weight_func,
                               dist_power = best_rmse$dist_power
) %>%
  # Specify the engine
  set_engine("kknn") %>% 
  # Specifying mode  
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/10_kNN/M+W+S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/10_kNN/M+W+S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/10_kNN/M+W+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/10_kNN/M+W+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/10_kNN/M+S+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/10_kNN/M+S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/10_kNN/W+S+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/10_kNN/W+S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <- nearest_neighbor(neighbors = best_rmse_3$neighbors,
                               weight_func = best_rmse_3$weight_func,
                               dist_power = best_rmse_3$dist_power
) %>%
  # Specify the engine
  set_engine("kknn") %>% 
  # Specifying mode  
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/10_kNN/M+W.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/10_kNN/M+W_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/10_kNN/M+S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/10_kNN/M+S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/10_kNN/M+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/10_kNN/M+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
plot <- final_fit %>%
  ...
  metrica::scatter_plot(obs = grade_n,
                        ...
                        metrics_list = c("R2", "RMSE"),
                      # Customize metrics position
                        position_metrics = c(x=77.5,y=73),
                        position_eq = c(x=77.5, y =70.5))
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/10_kNN/W+S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/10_kNN/W+S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/10_kNN/W+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/10_kNN/W+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/10_kNN/S+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/10_kNN/S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/10_kNN/M.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/10_kNN/M_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/10_kNN/W.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/10_kNN/W_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/10_kNN/S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/10_kNN/S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/10_kNN/O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/10_kNN/O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
