...
```{r final_spec}
final_spec <- bag_mars(num_terms = best_r2_3$num_terms,
                               prod_degree = best_r2_3$prod_degree,
                               prune_method = best_r2_3$prune_method
) %>%
  # Specify the engine
  set_engine("earth") %>% 
  # Specifying mode  
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/12_bag_MARS/M+W+S+O.png",
       width = 5,
       height = 5
       )
```
...
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/12_bag_MARS/M+W+S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <- bag_mars(num_terms = best_rmse_3$num_terms,
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/12_bag_MARS/M+W+S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/12_bag_MARS/M+W+S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <- bag_mars(num_terms = best_rmse$num_terms,
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/12_bag_MARS/M+W+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/12_bag_MARS/M+W+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/12_bag_MARS/M+S+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/12_bag_MARS/M+S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/12_bag_MARS/W+S+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/12_bag_MARS/W+S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <- bag_mars(num_terms = best_r2$num_terms,
                               prod_degree = best_r2$prod_degree,
                               prune_method = best_r2$prune_method
) %>%
  # Specify the engine
  set_engine("earth") %>% 
  # Specifying mode  
...
plot <- final_fit %>%
  ...
  metrica::scatter_plot(obs = grade_n,
                        ...
                        metrics_list = c("R2", "RMSE"),
                      # Customize metrics position
                        position_metrics = c(x=75,y=72.9),
                        position_eq = c(x=75, y =70.5))
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/12_bag_MARS/M+W.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/12_bag_MARS/M+W_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/12_bag_MARS/M+S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/12_bag_MARS/M+S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/12_bag_MARS/M+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/12_bag_MARS/M+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <- bag_mars(num_terms = best_rmse_2$num_terms,
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/12_bag_MARS/W+S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/12_bag_MARS/W+S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
plot <- final_fit %>%
  ...
  metrica::scatter_plot(obs = grade_n,
                        ...
                        metrics_list = c("R2", "RMSE"),
                      # Customize metrics position
                        position_metrics = c(x=73,y=72.8),
                        position_eq = c(x=73, y =70.8))
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/12_bag_MARS/W+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/12_bag_MARS/W+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/12_bag_MARS/S+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/12_bag_MARS/S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <- bag_mars(num_terms = best_r2_2$num_terms,
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/12_bag_MARS/M.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/12_bag_MARS/M_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
plot <- final_fit %>%
  ...
  metrica::scatter_plot(obs = grade_n,
                        ...
                        metrics_list = c("R2", "RMSE"),
                      # Customize metrics position
                        position_metrics = c(x=72,y=70.5),
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/12_bag_MARS/W.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/12_bag_MARS/W_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/12_bag_MARS/S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/12_bag_MARS/S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/12_bag_MARS/O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/12_bag_MARS/O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
