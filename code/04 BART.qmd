...
df <- read_sf("../data/data_complete.geojson") %>% 
  ...
  drop_na() %>% dplyr::filter(grade_n >65) %>% dplyr::filter(grade_n >65) 
...
bart_grid_result <- tune_race_anova(object = bart_dbarts_spec,
...
```{r final_spec}
final_spec <- parsnip::bart(trees = best_r2_3$trees,
                            prior_terminal_node_coef = best_r2_3$prior_terminal_node_coef,
                            prior_terminal_node_expo = best_r2_3$prior_terminal_node_expo,
                            prior_outcome_range = best_r2_3$prior_outcome_range) %>% 
  set_engine('dbarts') %>%
  set_mode('regression')
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade_Grade/02_BART/M+W+S+O.png",
       width = 5,
       height = 5
       )
```
...
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/02_BART/M+W+S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/02_BART/M+W+S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/02_BART/M+W+S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <- parsnip::bart(trees = best_r2$trees,
                            prior_terminal_node_coef = best_r2$prior_terminal_node_coef,
                            prior_terminal_node_expo = best_r2$prior_terminal_node_expo,
                            prior_outcome_range = best_r2$prior_outcome_range) %>% 
  set_engine('dbarts') %>%
  set_mode('regression')
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/02_BART/M+W+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/02_BART/M+W+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/02_BART/M+S+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/02_BART/M+S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
plot <- final_fit %>%
  ...
  metrica::scatter_plot(obs = grade_n,
                        ...
                        metrics_list = c("R2", "RMSE"),
                      # Customize metrics position
                        position_metrics = c(x=75,y=68.5),
                        position_eq = c(x=75, y =70.5))
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/02_BART/W+S+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/02_BART/W+S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/02_BART/M+W.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/02_BART/M+W_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/02_BART/M+S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/02_BART/M+S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/02_BART/M+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/02_BART/M+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/02_BART/W+S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/02_BART/W+S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
plot <- final_fit %>%
  ...
  metrica::scatter_plot(obs = grade_n,
                        ...
                        metrics_list = c("R2", "RMSE"),
                      # Customize metrics position
                        position_metrics = c(x=78,y=73.5),
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/02_BART/W+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/02_BART/W+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/02_BART/S+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/02_BART/S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/02_BART/M.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/02_BART/M_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <- parsnip::bart(trees = best_rmse$trees,
                            prior_terminal_node_coef = best_rmse$prior_terminal_node_coef,
                            prior_terminal_node_expo = best_rmse$prior_terminal_node_expo,
                            prior_outcome_range = best_rmse$prior_outcome_range) %>% 
  set_engine('dbarts') %>%
  set_mode('regression')
...
plot <- final_fit %>%
  ...
  metrica::scatter_plot(obs = grade_n,
                        ...
                        metrics_list = c("R2", "RMSE"),
                      # Customize metrics position
                        position_metrics = c(x=77,y=72),
                        position_eq = c(x=77, y =69))
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/02_BART/W.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/02_BART/W_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <- parsnip::bart(trees = best_rmse_3$trees,
                            prior_terminal_node_coef = best_rmse_3$prior_terminal_node_coef,
                            prior_terminal_node_expo = best_rmse_3$prior_terminal_node_expo,
                            prior_outcome_range = best_rmse_3$prior_outcome_range) %>% 
  set_engine('dbarts') %>%
  set_mode('regression')
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/02_BART/S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/02_BART/S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/02_BART/O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/02_BART/O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
