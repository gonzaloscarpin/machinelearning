...
compare_hyperparameters <- function(params_df, 
                                    recipe, 
                                    split) {
...
```{r final_spec}
final_spec <-   bag_mlp(hidden_units = best_rmse_3$hidden_units,
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/18_bagMLP/M+W+S+O.png",
       width = 5,
       height = 5
       )
```
...
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/18_bagMLP/M+W+S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <-   bag_mlp(hidden_units = best_rmse$hidden_units,
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/18_bagMLP/M+W+S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/18_bagMLP/M+W+S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/18_bagMLP/M+W+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/18_bagMLP/M+W+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <-   bag_mlp(hidden_units = best_rmse_2$hidden_units,
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/18_bagMLP/M+S+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/18_bagMLP/M+S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/18_bagMLP/W+S+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/18_bagMLP/W+S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/18_bagMLP/M+W.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/18_bagMLP/M+W_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/18_bagMLP/M+S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/18_bagMLP/M+S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/18_bagMLP/M+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/18_bagMLP/M+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/18_bagMLP/W+S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/18_bagMLP/W+S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <-   bag_mlp(hidden_units = best_r2_2$hidden_units,
...
plot <- final_fit %>%
  ...
  metrica::scatter_plot(obs = grade_n,
                        ...
                        metrics_list = c("R2", "RMSE"),
                      # Customize metrics position
                        position_metrics = c(x=78.5,y=74.5),
                        position_eq = c(x=78.5, y =71))
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/18_bagMLP/W+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/18_bagMLP/W+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/18_bagMLP/S+O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/18_bagMLP/S+O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/18_bagMLP/M.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/18_bagMLP/M_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/18_bagMLP/W.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/18_bagMLP/W_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/18_bagMLP/S.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/18_bagMLP/S_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
...
```{r final_spec}
final_spec <-   bag_mlp(hidden_units = best_r2$hidden_units,
...
```{r export first plot}
ggsave(plot = plot,
       filename = "../output/ML_Grade/18_bagMLP/O.png",
       width = 5,
       height = 5
       )
```
...
```{r export second plot}
ggsave(plot = plot_2,
       filename = "../output/ML_Grade/18_bagMLP/O_2.png",
       width = 5,
       height = 5,
       bg = "white"
       ) 
