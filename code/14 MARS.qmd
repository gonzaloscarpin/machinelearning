---
title: "14 Multivariate Adaptive Regression Splines"
format: html
---

# Multivariate adaptive regression splines model for Cotton Lint Yield Prediction
...
library(baguette)       # Fast implementation of MARS
...
We define a mars model with hyperparameters to be tuned.
...
mars_grid_result <- tune_race_anova(
  object = mars_spec,
...
This analysis demonstrates the application of MARS for predicting cotton lint yield. The model achieves good predictive performance, and Shapley values provide insights into the contribution of different features to the predictions.